...
const PLANS: Plan[] = [
  ...
  },
  {
    ...
    // payment link + webhook (which sets tier=crafter) keep working unchanged.
    tier: "crafter",
    name: "3D Designer",
    price: "$5.99",
    period: "/ month",
    tagline: "The full 3D Designer",
    color: "#7c3aed",
    priceEnvKey: import.meta.env.VITE_STRIPE_PRICE_CRAFTER ?? "",
    paymentLinkUrl: import.meta.env.VITE_STRIPE_PAYMENT_LINK_CRAFTER ?? "",
    features: [
      "Everything in Free",
      "Larger designs — 50×50 default, resize freely",
      "Reference image overlay & color transfer",
      "Spline fill & flood fill",
      "Export CSV ring list & PDF bill of materials",
      "1:1 physical pattern PDF (print tiles)",
